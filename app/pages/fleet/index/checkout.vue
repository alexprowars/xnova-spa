	...
	<div class="block">
		...
		<div class="content">
			<form v-if="page" ref="formRef" class="block-table text-center" method="post" @submit.prevent="send">
				...
				<div class="grid">
					<div class="c">{{ $t('pages.fleets.checkout.links') }} <NuxtLink to="/fleet/shortcut">{{ $t('pages.fleets.checkout.links_edit') }}</NuxtLink></div>
				</div>
				...
				<div v-else class="grid">
					<div class="th">
						<NuxtLink to="/fleet/shortcut/create" class="button">
